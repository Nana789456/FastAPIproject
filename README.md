...
2)	Творчество:
    - живопись:
        ...
        - `POST /creativity/painting/json` (ручка для добавления нового курса по живописи)
    - поэзия:
        ...
        - `POST /creativity/poetry/json` (ручка для добавления нового курса по поэтическому искусству)
    - музыка:
        ...
        - `POST /creativity/music/json` (ручка для добавления нового курса по музыке) 
3)  Видео материалы
4)  Фотогалерея
5)  Аудиозаписи
6)  Контакты
