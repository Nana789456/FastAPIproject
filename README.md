...
### Команда git apply принимает файл-патч (заплатку) и вносит описанные в нем изменения в вашу текущую рабочую директорию. Она полезна для тестирования чужого кода или переноса наработок без создания коммита в истории.