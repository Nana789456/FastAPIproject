...
async def upload(
    ...
    return video_service.upload(video_name, file)
...
async def get(
    ...
    return video_service.get(video_name)
...
async def get_file(
    ...
    return video_service.get_file(video_name, download=download)
...
async def get_last(
    ...
    return video_service.get_last(number)
